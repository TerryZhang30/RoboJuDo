...
policy_registry.add("HumanxPolicy", ".humanx_policy")
policy_registry.add("StandPolicy", ".stand_policy")
policy_registry.add("HumanxLoopPolicy", ".humanx_loop_policy")
policy_registry.add("PickballBCPolicy", ".pickball_bc_policy")
